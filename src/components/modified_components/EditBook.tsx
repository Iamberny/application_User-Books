...
import { Book, User, Pencil, Upload, ArrowLeft } from "lucide-react";
...
export default function EditBook() {
  ...
  return (
    <div className="flex justify-center p-4 md:p-6 lg:p-8 min-h-[800px]">
      <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto flex-1">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-sm text-gray-500">Books Section</span>
            <span className="text-lg font-semibold text-gray-900 leading-none">
              Book Details: {currentBook.name}
            </span>
          </div>
        </div>
          ...
          <div className="bg-white rounded-xl p-6 w-full lg:w-1/3 shadow-md flex flex-col h-full">
            <div className="flex flex-col items-center gap-4 flex-1">
              ...
              <div className="w-full mt-4">
                ...
                >
                  <User className={isEditing ? "text-gray-400" : ""} /> Sold
                  by...
                </button>
              </div>
            </div>
                ...
                <Input
                  ...
                  value={
                    currentBook.createdAt
                      ? new Date(currentBook.createdAt).toLocaleString(
                          "it-IT",
                          {
                            day: "2-digit",
                            month: "2-digit",
